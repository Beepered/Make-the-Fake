class UIScene extends Phaser.Scene
{
    ...
    create (){
        ...
        this.point_text = this.add.text(160, 75, '0', { font: '22px Arial', fill: '#000000' }).setOrigin(0.5)

        this.score_text = this.add.text(400, 50, 'HIGH SCORE', { font: '22px Arial', fill: '#000000' }).setOrigin(0.5)
