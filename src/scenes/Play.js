class Play extends Phaser.Scene {
  ...
  create() {
    ...
    this.spawn_time =
      this.minimum_spawn_time + Math.random() * this.variation_spawn_time;
    this.enemy_health = 0.1;
    this.enemy_speed = 60;
    ...
    this.person_spawn_time =
      this.minimum_person_spawn_time +
      Math.random() * this.variation_person_spawn_time;
